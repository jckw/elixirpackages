defmodule ElixirPackagesWeb.Admin.PackageInGridControllerTest do
  ...
  describe "create package_in_grid" do
    test "redirects to show when data is valid", %{conn: conn} do
      conn =
        post conn, Routes.admin_package_in_grid_path(conn, :create),
          package_in_grid: @create_attrs
  ...
  describe "edit package_in_grid" do
    ...
    test "renders form for editing chosen package_in_grid", %{
      conn: conn,
      package_in_grid: package_in_grid
    } do
  ...
  describe "update package_in_grid" do
    ...
    test "redirects when data is valid", %{conn: conn, package_in_grid: package_in_grid} do
      conn =
        put conn, Routes.admin_package_in_grid_path(conn, :update, package_in_grid),
          package_in_grid: @update_attrs

      assert redirected_to(conn) ==
               Routes.admin_package_in_grid_path(conn, :show, package_in_grid)
